...
Most of these come down to network reality or how mastodon serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

mastodon rate-limits like any public site. mastodon already paces
...
Where a surface is gated, mastodon reads a cookie or token you supply
...
`mastodon`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what mastodon actually did
