...
// HTTP behaviour is covered in mastodon_test.go.
...
func TestHostWiring(t *testing.T) {
	...
	if want := "mastodon://page/wiki/Go"; u.String() != want {
	...
	got, err := h.ResolveOn("mastodon", "about")
	if err != nil || got.String() != "mastodon://page/about" {
		t.Errorf("ResolveOn = (%q, %v), want mastodon://page/about", got.String(), err)
	}
}
